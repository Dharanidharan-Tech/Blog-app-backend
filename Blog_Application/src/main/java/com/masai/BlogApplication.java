...
public class BlogApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		boolean existsByEmail = userRepo.existsByEmail("dharanidharan@gmail.com");
		...
		if (existsByEmail) {
			...
			author.setEmail("dharanidharan@gmail.com");
			author.setAbout("student");
			author.setName("Default Admin");
			author.getRoles().add(adminRole);
			author.getRoles().add(userRole);
			author.setPassword(passwordEncoder.encode("Dharani1@4."));
